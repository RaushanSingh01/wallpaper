...
<body class="he">
    ...
    <div class="head">
        ...
        <span class="sapan0"><a href="#"><img src="image/logo.png" width="200px" height="60px"></a></span>
            <form action="androidsearch.php" method="get">
            ...
            <span><a href="downlode.php" class="sapan2">DOWNLOAD</a></span>
            <span><a href="uplode.php" class="sapan1">UPLODE</a></span>
            <span> Hi <?php
           echo $_SESSION['name3'];
            ?>
            </span>
            ...
            <span><a href="logout.php"><button input type="submit" class="sapan6"><b>LogOut</b></button></a></span>
        </div>
    ...
    <div class="body3">
        <div class="body4">
        <a href="android.php"><h3>HD Androids wallpapers</h3></a>
        </div>
        <div class="body5">
        <a href="animals.php"><h3>HD Animals wallpapers</h3></a>
        </div>
        <div class="body6">
        <a href="cars.php"><h3>HD Cars wallpapers</h3></a>
        </div>
    </div>
    <div class="wall">
    ...
    $sqlimage = "SELECT * FROM uplode WHERE CATEGORY='android'";
    ...
    while ($rows = mysqli_fetch_assoc($imageresult1)) {
        ...
        $SS = $name;
        $sqli=$_SESSION['name3'];
        mysqli_query($conn,"INSERT INTO `down` (USERNAME,name) VALUES ('$sqli','$SS')");
